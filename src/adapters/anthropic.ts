...
function effectivePromptCacheTtlMs(body: Record<string, unknown>): number | undefined {
...
export function usageFromAnthropic(usage: Record<string, unknown> | undefined): OcxUsage | undefined {
