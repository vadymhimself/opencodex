...
"common.discard": "Отбросить",
  ...
  "logs.detail.attempt.recovery.oauthAccount429": "Учётная запись OAuth ограничена (429)",
  "logs.detail.attempt.recovery.codexAccountRetry": "Повтор с учётной записью Codex",
  "logs.detail.attempt.recovery.adapterRetry": "Внутренняя повторная попытка адаптера",
  "logs.detail.attempt.recovery.image413": "Слишком большой размер изображения (413)",
  "logs.detail.attempt.recovery.opaqueBlobRejection": "Отклонение непрозрачного блока данных",
  ...
  "usage.quota.title": "Состояние квот физических маршрутов",
  "usage.quota.subtitle": "Поведение входных данных и кэша на уровне попыток по сохранённой истории маршрутизации. Число токенов — телеметрия, а не счёт провайдера.",
  "usage.quota.loading": "Загрузка телеметрии маршрутов…",
  "usage.quota.loadError": "Не удалось загрузить телеметрию маршрутов.",
  "usage.quota.staleAt": "Последнее обновление завершилось ошибкой. Ниже показаны устаревшие данные на {time}.",
  "usage.quota.partial": "Результаты неполны, поскольку история запросов или список предупреждений достигли предела.",
  "usage.quota.status.noData": "В этом диапазоне нет запросов по физическим маршрутам.",
  "usage.quota.status.noAttempts": "Запросы зарегистрированы, но ни один не отправил запрос вывода вышестоящему сервису.",
  "usage.quota.status.unsupportedTelemetry": "Телеметрия токенов не поддерживается для {count} физических попыток.",
  "usage.quota.status.unreportedTelemetry": "Телеметрия токенов отсутствует для {count} физических попыток.",
  "usage.quota.status.partialTelemetry": "Телеметрия токенов охватывает {measured} из {total} физических попыток ({unsupported} не поддерживаются, {unreported} не отчитаны).",
  "usage.quota.status.alerts": "В проверенной истории произошло предупреждений о квоте: {count}.",
  "usage.quota.status.warmingUp": "Маршрут прогревается; для оценки состояния кэша нужен ещё один запрос.",
  "usage.quota.status.clear": "В проверенной истории предупреждений о квоте не было.",
  "usage.quota.card.inclusiveInput": "Вход с учётом кэша",
  "usage.quota.card.rawInput": "Сырой вход",
  "usage.quota.card.cacheReads": "Чтения из кэша",
  "usage.quota.card.cacheWrites": "Записи в кэш",
  "usage.quota.card.physicalSends": "Физические отправки",
  "usage.quota.card.requestRate": "Запросов / час",
  "usage.quota.card.coverage": "Покрытие попыток",
  "usage.quota.card.recoveries": "Восстановления",
  "usage.quota.routes": "Физические маршруты провайдеров / моделей",
  "usage.quota.alerts": "Предупреждения маршрутов и сессий",
  "usage.quota.alertsEmpty": "В проверенной истории нет предупреждений маршрутов или сессий.",
  "usage.quota.alertsPreview": "Показано {shown} из {total} полученных предупреждений.",
  "usage.quota.col.route": "Провайдер / модель",
  "usage.quota.col.requests": "Запросы",
  "usage.quota.col.attempts": "Попытки",
  "usage.quota.col.sends": "Отправки",
  "usage.quota.col.raw": "Сырой вход",
  "usage.quota.col.read": "Чтение из кэша",
  "usage.quota.col.write": "Запись в кэш",
  "usage.quota.col.recoveries": "Восстановления",
  "usage.quota.col.failovers": "Переключения",
  "usage.quota.col.rate": "Запросов / час",
  "usage.quota.col.coverage": "Покрытие",
  "usage.quota.col.alert": "Предупреждение",
  "usage.quota.col.session": "Сессия",
  "usage.quota.col.time": "Время",
  "usage.quota.col.value": "Значение",
  "usage.quota.alert.consecutive-high-raw-input": "Сырой вход дважды превысил 100 тыс.",
  "usage.quota.alert.high-cache-write-after-warmup": "Запись в кэш после прогрева превысила 10 тыс.",
  "usage.quota.alert.low-cache-read-share-after-warmup": "Доля чтений из кэша после прогрева ниже 90%",
  "usage.quota.alert.falling-cache-read": "Число чтений из кэша снизилось",
  "usage.quota.alert.recovery": "Произошло восстановление",
  "usage.quota.alert.repeated-send": "Попытка отправлена несколько раз",
  "usage.quota.alert.combo-failover": "Произошло переключение комбинации",
