...
"common.discard": "Отбросить",
  ...
  "dash.quota.title": "Контроль квоты",
  "dash.quota.loading": "Загрузка недавней телеметрии квоты…",
  "dash.quota.unavailable": "Недавняя телеметрия квоты недоступна.",
  "dash.quota.refresh": "Обновить",
  "dash.quota.healthy": "В недавнем окне нет регрессий квоты.",
  "dash.quota.alert": "Обнаружена регрессия квоты. Проверьте логи перед продолжением тяжёлой работы.",
  "dash.quota.rawInput": "Необработанный ввод",
  "dash.quota.cache": "Использование кэша",
  "dash.quota.rate": "Запросы / мин",
  "dash.quota.sends": "Физические отправки",
  "dash.quota.retries": "Повторные отправки",
  "dash.quota.updated": "Последняя активность: {at}",
  "dash.quota.signal.rawInput": "Необработанный ввод >100k дважды",
  "dash.quota.signal.cacheWrite": "Запись кэша >10k после прогрева",
  "dash.quota.signal.cacheRead": "Чтения кэша упали",
  "dash.quota.signal.retry": "Повтор или восстановление",
  ...
  "usage.card.cachedTokens": "Использование кэша",
  "usage.card.cachedTokensHint": "Доля трафика кэша, обслуженная чтениями из кэша: чтения / (чтения + записи).",
