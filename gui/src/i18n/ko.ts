...
"common.discard": "버리기",
  ...
  "logs.detail.attempt.recovery.codexAccountRetry": "Codex 계정 재시도",
  "logs.detail.attempt.recovery.adapterRetry": "어댑터 내부 재시도",
  "logs.detail.attempt.recovery.image413": "이미지 페이로드가 너무 큼 (413)",
  "logs.detail.attempt.recovery.opaqueBlobRejection": "불투명 페이로드 거부",
  ...
  "usage.quota.title": "물리 경로 할당량 상태",
  "usage.quota.subtitle": "영구 저장된 라우팅 기록에서 집계한 시도별 입력 및 캐시 동작입니다. 토큰 수는 텔레메트리이며 공급자 청구서가 아닙니다.",
  "usage.quota.loading": "경로 텔레메트리를 불러오는 중…",
  "usage.quota.loadError": "경로 텔레메트리를 불러오지 못했습니다.",
  "usage.quota.staleAt": "최근 새로고침에 실패했습니다. 아래 값은 {time} 기준의 오래된 데이터입니다.",
  "usage.quota.partial": "요청 기록 또는 경고 출력이 한도에 도달하여 일부 결과만 표시됩니다.",
  "usage.quota.status.noData": "이 기간에는 물리 경로 요청이 없습니다.",
  "usage.quota.status.noAttempts": "요청은 기록되었지만 업스트림 추론은 전송되지 않았습니다.",
  "usage.quota.status.unsupportedTelemetry": "물리 시도 {count}건은 토큰 텔레메트리를 지원하지 않습니다.",
  "usage.quota.status.unreportedTelemetry": "물리 시도 {count}건의 토큰 텔레메트리가 누락되었습니다.",
  "usage.quota.status.partialTelemetry": "토큰 텔레메트리는 물리 시도 {total}건 중 {measured}건을 포함합니다(미지원 {unsupported}건, 미보고 {unreported}건).",
  "usage.quota.status.alerts": "검사한 기록에서 할당량 경고가 {count}건 발생했습니다.",
  "usage.quota.status.warmingUp": "경로 워밍업 중이며 캐시 상태를 확인하려면 요청이 한 번 더 필요합니다.",
  "usage.quota.status.clear": "검사한 기록에서 할당량 경고가 발생하지 않았습니다.",
  "usage.quota.card.inclusiveInput": "캐시 포함 입력",
  "usage.quota.card.rawInput": "원시 입력",
  "usage.quota.card.cacheReads": "캐시 읽기",
  "usage.quota.card.cacheWrites": "캐시 쓰기",
  "usage.quota.card.physicalSends": "물리 전송",
  "usage.quota.card.requestRate": "시간당 요청",
  "usage.quota.card.coverage": "시도 커버리지",
  "usage.quota.card.recoveries": "복구",
  "usage.quota.routes": "물리 공급자 / 모델 경로",
  "usage.quota.alerts": "경로 및 세션 경고",
  "usage.quota.alertsEmpty": "검사한 기록에 경로 또는 세션 경고가 없습니다.",
  "usage.quota.alertsPreview": "반환된 경고 {total}건 중 {shown}건을 표시합니다.",
  "usage.quota.col.route": "공급자 / 모델",
  "usage.quota.col.requests": "요청",
  "usage.quota.col.attempts": "시도",
  "usage.quota.col.sends": "전송",
  "usage.quota.col.raw": "원시 입력",
  "usage.quota.col.read": "캐시 읽기",
  "usage.quota.col.write": "캐시 쓰기",
  "usage.quota.col.recoveries": "복구",
  "usage.quota.col.failovers": "장애 조치",
  "usage.quota.col.rate": "시간당 요청",
  "usage.quota.col.coverage": "커버리지",
  "usage.quota.col.alert": "경고",
  "usage.quota.col.session": "세션",
  "usage.quota.col.time": "시간",
  "usage.quota.col.value": "값",
  "usage.quota.alert.consecutive-high-raw-input": "원시 입력이 2회 연속 100k 초과",
  "usage.quota.alert.high-cache-write-after-warmup": "워밍업 후 캐시 쓰기가 10k 초과",
  "usage.quota.alert.low-cache-read-share-after-warmup": "워밍업 후 캐시 읽기 비율이 90% 미만",
  "usage.quota.alert.falling-cache-read": "캐시 읽기 감소",
  "usage.quota.alert.recovery": "복구 발생",
  "usage.quota.alert.repeated-send": "시도를 두 번 이상 전송함",
  "usage.quota.alert.combo-failover": "콤보 장애 조치 발생",
