...
"common.discard": "버리기",
  ...
  "dash.quota.title": "할당량 감시",
  "dash.quota.loading": "최근 할당량 텔레메트리를 불러오는 중…",
  "dash.quota.unavailable": "최근 할당량 텔레메트리를 사용할 수 없습니다.",
  "dash.quota.refresh": "새로고침",
  "dash.quota.healthy": "최근 기간에 할당량 회귀가 없습니다.",
  "dash.quota.alert": "할당량 회귀가 감지되었습니다. 무거운 작업을 계속하기 전 로그를 확인하세요.",
  "dash.quota.rawInput": "원시 입력",
  "dash.quota.cache": "캐시 사용률",
  "dash.quota.rate": "요청 / 분",
  "dash.quota.sends": "실제 전송",
  "dash.quota.retries": "재시도 전송",
  "dash.quota.updated": "마지막 활동: {at}",
  "dash.quota.signal.rawInput": "원시 입력 >100k 2회",
  "dash.quota.signal.cacheWrite": "워밍업 후 캐시 쓰기 >10k",
  "dash.quota.signal.cacheRead": "캐시 읽기 감소",
  "dash.quota.signal.retry": "재시도 또는 복구",
  ...
  "usage.card.cachedTokens": "캐시 활용률",
  "usage.card.cachedTokensHint": "캐시 트래픽 중 캐시 읽기로 처리된 비율: 읽기 / (읽기 + 쓰기).",
