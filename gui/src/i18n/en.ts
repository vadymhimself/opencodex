...
"common.discard": "Discard",
  ...
  "dash.quota.title": "Quota watch",
  "dash.quota.loading": "Loading recent quota telemetry…",
  "dash.quota.unavailable": "Recent quota telemetry unavailable.",
  "dash.quota.refresh": "Refresh",
  "dash.quota.healthy": "No quota regressions in the recent window.",
  "dash.quota.alert": "Quota regression detected. Inspect Logs before continuing heavy work.",
  "dash.quota.rawInput": "Raw input",
  "dash.quota.cache": "Cache utilization",
  "dash.quota.rate": "Requests / min",
  "dash.quota.sends": "Physical sends",
  "dash.quota.retries": "Retry sends",
  "dash.quota.updated": "Last activity: {at}",
  "dash.quota.signal.rawInput": "Raw input >100k twice",
  "dash.quota.signal.cacheWrite": "Cache write >10k after warm-up",
  "dash.quota.signal.cacheRead": "Cache reads fell",
  "dash.quota.signal.retry": "Retry or recovery",
  ...
  "usage.card.cachedTokens": "Cache utilization",
  "usage.card.cachedTokensHint": "Share of cache traffic served from cache: reads / (reads + writes).",
