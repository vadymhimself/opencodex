...
"common.discard": "Discard",
  ...
  "logs.detail.attempt.recovery.codexAccountRetry": "Codex account retry",
  "logs.detail.attempt.recovery.adapterRetry": "Adapter-internal retry",
  "logs.detail.attempt.recovery.image413": "Image payload too large (413)",
  "logs.detail.attempt.recovery.opaqueBlobRejection": "Opaque payload rejection",
  ...
  "usage.quota.title": "Physical-route quota health",
  "usage.quota.subtitle": "Attempt-level input and cache behavior from durable routing history. Token counts are telemetry, not a provider invoice.",
  "usage.quota.loading": "Loading route telemetry…",
  "usage.quota.loadError": "Could not load route telemetry.",
  "usage.quota.staleAt": "Latest refresh failed. Values below are stale from {time}.",
  "usage.quota.partial": "Results are partial because request history or alert output reached its limit.",
  "usage.quota.status.noData": "No physical-route requests in this range.",
  "usage.quota.status.noAttempts": "Requests were recorded, but none sent an upstream inference.",
  "usage.quota.status.unsupportedTelemetry": "Token telemetry is unsupported for {count} physical attempt(s).",
  "usage.quota.status.unreportedTelemetry": "Token telemetry is missing for {count} physical attempt(s).",
  "usage.quota.status.partialTelemetry": "Token telemetry covers {measured} of {total} physical attempts ({unsupported} unsupported, {unreported} unreported).",
  "usage.quota.status.alerts": "{count} quota warning occurrence(s) in scanned history.",
  "usage.quota.status.warmingUp": "Route is warming up; cache health needs another request.",
  "usage.quota.status.clear": "No quota warning occurrences in scanned history.",
  "usage.quota.card.inclusiveInput": "Inclusive input",
  "usage.quota.card.rawInput": "Raw input",
  "usage.quota.card.cacheReads": "Cache reads",
  "usage.quota.card.cacheWrites": "Cache writes",
  "usage.quota.card.physicalSends": "Physical sends",
  "usage.quota.card.requestRate": "Requests / hour",
  "usage.quota.card.coverage": "Attempt coverage",
  "usage.quota.card.recoveries": "Recoveries",
  "usage.quota.routes": "Physical provider / model routes",
  "usage.quota.alerts": "Route and session warnings",
  "usage.quota.alertsEmpty": "No route or session warnings in scanned history.",
  "usage.quota.alertsPreview": "Showing {shown} of {total} returned warning occurrences.",
  "usage.quota.col.route": "Provider / model",
  "usage.quota.col.requests": "Requests",
  "usage.quota.col.attempts": "Attempts",
  "usage.quota.col.sends": "Sends",
  "usage.quota.col.raw": "Raw input",
  "usage.quota.col.read": "Cache read",
  "usage.quota.col.write": "Cache write",
  "usage.quota.col.recoveries": "Recoveries",
  "usage.quota.col.failovers": "Failovers",
  "usage.quota.col.rate": "Requests / hour",
  "usage.quota.col.coverage": "Coverage",
  "usage.quota.col.alert": "Warning",
  "usage.quota.col.session": "Session",
  "usage.quota.col.time": "Time",
  "usage.quota.col.value": "Value",
  "usage.quota.alert.consecutive-high-raw-input": "Raw input above 100k twice",
  "usage.quota.alert.high-cache-write-after-warmup": "Cache write above 10k after warm-up",
  "usage.quota.alert.low-cache-read-share-after-warmup": "Cache-read share below 90% after warm-up",
  "usage.quota.alert.falling-cache-read": "Cache reads fell",
  "usage.quota.alert.recovery": "Recovery occurred",
  "usage.quota.alert.repeated-send": "Attempt sent more than once",
  "usage.quota.alert.combo-failover": "Combo failover occurred",
