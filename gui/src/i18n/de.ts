...
"common.discard": "Verwerfen",
  ...
  "logs.detail.attempt.recovery.codexAccountRetry": "Codex-Kontowiederholung",
  "logs.detail.attempt.recovery.adapterRetry": "Adapterinterner Wiederholungsversuch",
  "logs.detail.attempt.recovery.image413": "Bildnutzlast zu groß (413)",
  "logs.detail.attempt.recovery.opaqueBlobRejection": "Undurchsichtige Nutzlast abgelehnt",
  ...
  "usage.quota.title": "Kontingentstatus physischer Routen",
  "usage.quota.subtitle": "Eingabe- und Cache-Verhalten pro Versuch aus dem dauerhaft gespeicherten Routing-Verlauf. Token-Zahlen sind Telemetriedaten, keine Anbieterrechnung.",
  "usage.quota.loading": "Routentelemetrie wird geladen…",
  "usage.quota.loadError": "Routentelemetrie konnte nicht geladen werden.",
  "usage.quota.staleAt": "Die letzte Aktualisierung ist fehlgeschlagen. Die folgenden Werte sind veraltet und stammen von {time}.",
  "usage.quota.partial": "Die Ergebnisse sind unvollständig, da der Anfrageverlauf oder die Warnungsausgabe ihr Limit erreicht hat.",
  "usage.quota.status.noData": "Keine Anfragen über physische Routen in diesem Zeitraum.",
  "usage.quota.status.noAttempts": "Anfragen wurden erfasst, aber keine vorgelagerte Inferenz wurde gesendet.",
  "usage.quota.status.unsupportedTelemetry": "Token-Telemetrie wird für {count} physische Versuche nicht unterstützt.",
  "usage.quota.status.unreportedTelemetry": "Token-Telemetrie fehlt für {count} physische Versuche.",
  "usage.quota.status.partialTelemetry": "Token-Telemetrie deckt {measured} von {total} physischen Versuchen ab ({unsupported} nicht unterstützt, {unreported} nicht gemeldet).",
  "usage.quota.status.alerts": "{count} Kontingentwarnungen im geprüften Verlauf aufgetreten.",
  "usage.quota.status.warmingUp": "Die Route wird aufgewärmt; für den Cache-Status ist eine weitere Anfrage erforderlich.",
  "usage.quota.status.clear": "Keine Kontingentwarnungen im geprüften Verlauf aufgetreten.",
  "usage.quota.card.inclusiveInput": "Eingabe einschließlich Cache",
  "usage.quota.card.rawInput": "Roheingabe",
  "usage.quota.card.cacheReads": "Cache-Lesevorgänge",
  "usage.quota.card.cacheWrites": "Cache-Schreibvorgänge",
  "usage.quota.card.physicalSends": "Physische Sendevorgänge",
  "usage.quota.card.requestRate": "Anfragen / Stunde",
  "usage.quota.card.coverage": "Versuchsabdeckung",
  "usage.quota.card.recoveries": "Wiederherstellungen",
  "usage.quota.routes": "Physische Anbieter-/Modellrouten",
  "usage.quota.alerts": "Routen- und Sitzungswarnungen",
  "usage.quota.alertsEmpty": "Keine Routen- oder Sitzungswarnungen im geprüften Verlauf.",
  "usage.quota.alertsPreview": "{shown} von {total} zurückgegebenen Warnungen werden angezeigt.",
  "usage.quota.col.route": "Anbieter / Modell",
  "usage.quota.col.requests": "Anfragen",
  "usage.quota.col.attempts": "Versuche",
  "usage.quota.col.sends": "Sendevorgänge",
  "usage.quota.col.raw": "Roheingabe",
  "usage.quota.col.read": "Cache-Lesevorgang",
  "usage.quota.col.write": "Cache-Schreibvorgang",
  "usage.quota.col.recoveries": "Wiederherstellungen",
  "usage.quota.col.failovers": "Failover",
  "usage.quota.col.rate": "Anfragen / Stunde",
  "usage.quota.col.coverage": "Abdeckung",
  "usage.quota.col.alert": "Warnung",
  "usage.quota.col.session": "Sitzung",
  "usage.quota.col.time": "Zeit",
  "usage.quota.col.value": "Wert",
  "usage.quota.alert.consecutive-high-raw-input": "Roheingabe zweimal über 100k",
  "usage.quota.alert.high-cache-write-after-warmup": "Cache-Schreibvorgang nach dem Aufwärmen über 10k",
  "usage.quota.alert.low-cache-read-share-after-warmup": "Cache-Leseanteil nach dem Aufwärmen unter 90 %",
  "usage.quota.alert.falling-cache-read": "Cache-Lesevorgänge sind gesunken",
  "usage.quota.alert.recovery": "Wiederherstellung ist erfolgt",
  "usage.quota.alert.repeated-send": "Versuch wurde mehrmals gesendet",
  "usage.quota.alert.combo-failover": "Combo-Failover ist erfolgt",
