...
"common.discard": "Verwerfen",
  ...
  "dash.quota.title": "Kontingentüberwachung",
  "dash.quota.loading": "Aktuelle Kontingent-Telemetrie wird geladen…",
  "dash.quota.unavailable": "Aktuelle Kontingent-Telemetrie nicht verfügbar.",
  "dash.quota.refresh": "Aktualisieren",
  "dash.quota.healthy": "Keine Kontingent-Regressionswarnungen im aktuellen Zeitfenster.",
  "dash.quota.alert": "Kontingent-Regression erkannt. Prüfen Sie Logs vor weiterer umfangreicher Arbeit.",
  "dash.quota.rawInput": "Roheingabe",
  "dash.quota.cache": "Cache-Auslastung",
  "dash.quota.rate": "Anfragen / Min.",
  "dash.quota.sends": "Physische Sends",
  "dash.quota.retries": "Retry-Sends",
  "dash.quota.updated": "Letzte Aktivität: {at}",
  "dash.quota.signal.rawInput": "Roheingabe >100k zweimal",
  "dash.quota.signal.cacheWrite": "Cache-Write >10k nach Aufwärmen",
  "dash.quota.signal.cacheRead": "Cache-Reads gefallen",
  "dash.quota.signal.retry": "Retry oder Wiederherstellung",
  ...
  "usage.card.cachedTokens": "Cache-Nutzung",
  "usage.card.cachedTokensHint": "Anteil des Cache-Datenverkehrs aus Lesevorgängen: Lesevorgänge / (Lesevorgänge + Schreibvorgänge).",
