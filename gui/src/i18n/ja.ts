...
"common.discard": "破棄",
  ...
  "dash.quota.title": "クォータ監視",
  "dash.quota.loading": "直近のクォータテレメトリーを読み込み中…",
  "dash.quota.unavailable": "直近のクォータテレメトリーを利用できません。",
  "dash.quota.refresh": "更新",
  "dash.quota.healthy": "直近の期間にクォータ回帰はありません。",
  "dash.quota.alert": "クォータ回帰を検出しました。重い作業を続ける前にログを確認してください。",
  "dash.quota.rawInput": "生入力",
  "dash.quota.cache": "キャッシュ利用率",
  "dash.quota.rate": "リクエスト / 分",
  "dash.quota.sends": "物理送信",
  "dash.quota.retries": "再試行送信",
  "dash.quota.updated": "最終アクティビティ: {at}",
  "dash.quota.signal.rawInput": "生入力 >100k が2回",
  "dash.quota.signal.cacheWrite": "ウォームアップ後のキャッシュ書き込み >10k",
  "dash.quota.signal.cacheRead": "キャッシュ読み取りが低下",
  "dash.quota.signal.retry": "再試行または回復",
  ...
  "usage.card.cachedTokens": "キャッシュ利用率",
  "usage.card.cachedTokensHint": "キャッシュトラフィックのうちキャッシュ読み取りで処理された割合: 読み取り / (読み取り + 書き込み)。",
