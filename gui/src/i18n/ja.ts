...
"common.discard": "破棄",
  ...
  "logs.detail.attempt.recovery.codexAccountRetry": "Codex アカウントの再試行",
  "logs.detail.attempt.recovery.adapterRetry": "アダプター内部の再試行",
  "logs.detail.attempt.recovery.image413": "画像ペイロードが大きすぎます (413)",
  "logs.detail.attempt.recovery.opaqueBlobRejection": "不透明ペイロードの拒否",
  ...
  "usage.quota.title": "物理ルートのクォータ状態",
  "usage.quota.subtitle": "永続化されたルーティング履歴に基づく、試行単位の入力とキャッシュの動作です。トークン数はテレメトリであり、プロバイダーの請求書ではありません。",
  "usage.quota.loading": "ルートテレメトリを読み込み中…",
  "usage.quota.loadError": "ルートテレメトリを読み込めませんでした。",
  "usage.quota.staleAt": "最新の更新に失敗しました。以下の値は {time} 時点の古いデータです。",
  "usage.quota.partial": "リクエスト履歴または警告出力が上限に達したため、結果は一部のみです。",
  "usage.quota.status.noData": "この期間に物理ルートへのリクエストはありません。",
  "usage.quota.status.noAttempts": "リクエストは記録されましたが、上流への推論送信はありませんでした。",
  "usage.quota.status.unsupportedTelemetry": "{count} 件の物理試行ではトークンテレメトリがサポートされていません。",
  "usage.quota.status.unreportedTelemetry": "{count} 件の物理試行でトークンテレメトリが欠落しています。",
  "usage.quota.status.partialTelemetry": "トークンテレメトリは物理試行 {total} 件中 {measured} 件をカバーしています（未対応 {unsupported} 件、未報告 {unreported} 件）。",
  "usage.quota.status.alerts": "スキャン済み履歴でクォータ警告が {count} 件発生しました。",
  "usage.quota.status.warmingUp": "ルートをウォームアップ中です。キャッシュ状態の判定にはもう 1 件のリクエストが必要です。",
  "usage.quota.status.clear": "スキャン済み履歴でクォータ警告は発生していません。",
  "usage.quota.card.inclusiveInput": "キャッシュ込みの入力",
  "usage.quota.card.rawInput": "生入力",
  "usage.quota.card.cacheReads": "キャッシュ読み取り",
  "usage.quota.card.cacheWrites": "キャッシュ書き込み",
  "usage.quota.card.physicalSends": "物理送信",
  "usage.quota.card.requestRate": "リクエスト / 時間",
  "usage.quota.card.coverage": "試行カバレッジ",
  "usage.quota.card.recoveries": "リカバリ",
  "usage.quota.routes": "物理プロバイダー / モデルルート",
  "usage.quota.alerts": "ルートとセッションの警告",
  "usage.quota.alertsEmpty": "スキャン済み履歴にルートまたはセッションの警告はありません。",
  "usage.quota.alertsPreview": "返された警告 {total} 件のうち {shown} 件を表示しています。",
  "usage.quota.col.route": "プロバイダー / モデル",
  "usage.quota.col.requests": "リクエスト",
  "usage.quota.col.attempts": "試行",
  "usage.quota.col.sends": "送信",
  "usage.quota.col.raw": "生入力",
  "usage.quota.col.read": "キャッシュ読み取り",
  "usage.quota.col.write": "キャッシュ書き込み",
  "usage.quota.col.recoveries": "リカバリ",
  "usage.quota.col.failovers": "フェイルオーバー",
  "usage.quota.col.rate": "リクエスト / 時間",
  "usage.quota.col.coverage": "カバレッジ",
  "usage.quota.col.alert": "警告",
  "usage.quota.col.session": "セッション",
  "usage.quota.col.time": "時刻",
  "usage.quota.col.value": "値",
  "usage.quota.alert.consecutive-high-raw-input": "生入力が 2 回連続で 100k 超",
  "usage.quota.alert.high-cache-write-after-warmup": "ウォームアップ後のキャッシュ書き込みが 10k 超",
  "usage.quota.alert.low-cache-read-share-after-warmup": "ウォームアップ後のキャッシュ読み取り比率が 90% 未満",
  "usage.quota.alert.falling-cache-read": "キャッシュ読み取りが減少",
  "usage.quota.alert.recovery": "リカバリが発生",
  "usage.quota.alert.repeated-send": "試行が複数回送信されました",
  "usage.quota.alert.combo-failover": "コンボのフェイルオーバーが発生",
