...
"common.discard": "丢弃",
  ...
  "logs.detail.attempt.recovery.codexAccountRetry": "Codex 账户重试",
  "logs.detail.attempt.recovery.adapterRetry": "适配器内部重试",
  "logs.detail.attempt.recovery.image413": "图片载荷过大 (413)",
  "logs.detail.attempt.recovery.opaqueBlobRejection": "不透明载荷被拒",
  ...
  "usage.quota.title": "物理路由配额健康状况",
  "usage.quota.subtitle": "基于持久化路由历史的逐次尝试输入与缓存行为。Token 数仅为遥测数据，并非提供商账单。",
  "usage.quota.loading": "正在加载路由遥测数据…",
  "usage.quota.loadError": "无法加载路由遥测数据。",
  "usage.quota.staleAt": "最新刷新失败。以下数值是截至 {time} 的过期数据。",
  "usage.quota.partial": "请求历史或警报输出达到上限，因此结果不完整。",
  "usage.quota.status.noData": "此时间范围内没有物理路由请求。",
  "usage.quota.status.noAttempts": "已记录请求，但没有向上游发送推理请求。",
  "usage.quota.status.unsupportedTelemetry": "{count} 次物理尝试不支持 Token 遥测。",
  "usage.quota.status.unreportedTelemetry": "{count} 次物理尝试缺少 Token 遥测。",
  "usage.quota.status.partialTelemetry": "Token 遥测覆盖 {total} 次物理尝试中的 {measured} 次（{unsupported} 次不支持，{unreported} 次未报告）。",
  "usage.quota.status.alerts": "扫描的历史记录中发生了 {count} 条配额警告。",
  "usage.quota.status.warmingUp": "路由正在预热；还需一次请求才能评估缓存状态。",
  "usage.quota.status.clear": "扫描的历史记录中未发生配额警告。",
  "usage.quota.card.inclusiveInput": "输入总量（含缓存）",
  "usage.quota.card.rawInput": "原始输入",
  "usage.quota.card.cacheReads": "缓存读取",
  "usage.quota.card.cacheWrites": "缓存写入",
  "usage.quota.card.physicalSends": "物理发送次数",
  "usage.quota.card.requestRate": "每小时请求数",
  "usage.quota.card.coverage": "尝试覆盖率",
  "usage.quota.card.recoveries": "恢复次数",
  "usage.quota.routes": "提供商 / 模型的物理路由",
  "usage.quota.alerts": "路由和会话警告",
  "usage.quota.alertsEmpty": "扫描的历史记录中没有路由或会话警告。",
  "usage.quota.alertsPreview": "显示返回的 {total} 条警告中的 {shown} 条。",
  "usage.quota.col.route": "提供商 / 模型",
  "usage.quota.col.requests": "请求",
  "usage.quota.col.attempts": "尝试",
  "usage.quota.col.sends": "发送",
  "usage.quota.col.raw": "原始输入",
  "usage.quota.col.read": "缓存读取",
  "usage.quota.col.write": "缓存写入",
  "usage.quota.col.recoveries": "恢复",
  "usage.quota.col.failovers": "故障转移",
  "usage.quota.col.rate": "每小时请求数",
  "usage.quota.col.coverage": "覆盖率",
  "usage.quota.col.alert": "警告",
  "usage.quota.col.session": "会话",
  "usage.quota.col.time": "时间",
  "usage.quota.col.value": "数值",
  "usage.quota.alert.consecutive-high-raw-input": "原始输入连续两次超过 100k",
  "usage.quota.alert.high-cache-write-after-warmup": "预热后缓存写入超过 10k",
  "usage.quota.alert.low-cache-read-share-after-warmup": "预热后缓存读取占比低于 90%",
  "usage.quota.alert.falling-cache-read": "缓存读取量下降",
  "usage.quota.alert.recovery": "发生恢复",
  "usage.quota.alert.repeated-send": "同一尝试发送多次",
  "usage.quota.alert.combo-failover": "发生组合故障转移",
