...
"common.discard": "丢弃",
  ...
  "dash.quota.title": "额度监控",
  "dash.quota.loading": "正在加载近期额度遥测…",
  "dash.quota.unavailable": "近期额度遥测不可用。",
  "dash.quota.refresh": "刷新",
  "dash.quota.healthy": "近期窗口内未发现额度回归。",
  "dash.quota.alert": "检测到额度回归。继续高负载工作前请检查日志。",
  "dash.quota.rawInput": "原始输入",
  "dash.quota.cache": "缓存利用率",
  "dash.quota.rate": "请求 / 分钟",
  "dash.quota.sends": "物理发送",
  "dash.quota.retries": "重试发送",
  "dash.quota.updated": "最后活动：{at}",
  "dash.quota.signal.rawInput": "原始输入 >100k 两次",
  "dash.quota.signal.cacheWrite": "预热后缓存写入 >10k",
  "dash.quota.signal.cacheRead": "缓存读取下降",
  "dash.quota.signal.retry": "重试或恢复",
  ...
  "usage.card.cachedTokens": "缓存利用率",
  "usage.card.cachedTokensHint": "由缓存读取提供的缓存流量占比：读取 /（读取 + 写入）。",
